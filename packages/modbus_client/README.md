...
- [Modbus Client Serial over TPC/IP](https://pub.dev/packages/modbus_client_serial_over_tcp) implements the ASCII and RTU protocols to send requests over TCP/IP or Websocket **RTU over TCP/IP**
