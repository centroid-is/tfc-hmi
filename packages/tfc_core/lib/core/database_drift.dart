...
/// Get the database directory path for pure Dart applications.
/// Returns ~/.local/share/tfc or /var/lib/tfc depending on context.
String _getDatabaseDirectory() {
  final home = Platform.environment['HOME'];
  if (home != null && home.isNotEmpty) {
    return p.join(home, '.local', 'share', 'tfc');
  }
...
class AppDatabase extends _$AppDatabase {
  ...
  static Future<AppDatabase> create(DatabaseConfig config) async {
    ...
    final dbFolder = _getDatabaseDirectory();
