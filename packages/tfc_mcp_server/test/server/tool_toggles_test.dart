...
void main() {
  ...
  group('Conditional tool registration', () {
    ...
    test('allEnabled registers 27 tools (18 read + 9 write)', () async {
    ...
    test('tagsEnabled=false registers 24 tools', () async {
      final server = createServer(
    ...
    test('alarmsEnabled=false registers 20 tools', () async {
      final server = createServer(
