...
Map<String, String> makeWeightFields({
  ...
  String tare = '0.38',
  String target = '12.3',
  String fGiveaway = '1.3',
  String vGiveaway = '0',
  String tareType = 'auto',
}) {
  return {
    ...
    '${M2400Field.status.id}': status,
    '${M2400Field.tare.id}': tare,
    '${M2400Field.target.id}': target,
    '${M2400Field.fGiveaway.id}': fGiveaway,
    '${M2400Field.vGiveaway.id}': vGiveaway,
    '${M2400Field.tareType.id}': tareType,
  };
}
  ...
  void pushWeightRecord({
    ...
    _send(M2400RecordType.recBatch.id,
        makeWeightFields(
          ...
          material: material, status: status, tare: tare,
          target: target, fGiveaway: fGiveaway, vGiveaway: vGiveaway,
          tareType: tareType,
        ));
  }
