...
- [ ] **DV-02**: M2400 parsed records convert to DynamicValue (full record as object, fields as typed values)

### state_man Integration

- [ ] **SM-01**: M2400ClientWrapper follows ClientWrapper pattern (connect, disconnect, status stream)
- [ ] **SM-02**: state_man subscribe returns Stream<DynamicValue> for M2400 keys
- [ ] **SM-03**: Named key addressing -- WGT for full record DynamicValue, WGT.WEIGHT for individual field
- [ ] **SM-04**: Connection status integrated into state_man status reporting
