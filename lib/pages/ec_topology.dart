...
class EcTopologyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseScaffold(
      title: 'Beckhoff EL1008 Modules',
      body: Center(
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            // First module with alternating LEDs
            ModuleWidget(
              ledStates: [true, false, true, false, true, false, true, false],
              width: 80,
            ),
            SizedBox(width: 20),
            // Second module with inverse pattern
            ModuleWidget(
              ledStates: [false, true, false, true, false, true, false, true],
              width: 80,
            ),
          ],
        ),
